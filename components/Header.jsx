...
const Header = () => {
    ...
    return (
      ...
      <Wrapper className="h-[60px] flex justify-between items-center">
        <Link href="/">
          <img src="/logo.png" className="w-[80px] md:w-[100px]" alt="Logo" />
        </Link>
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          {session ? (
            <div className="relative inline-block text-left">
              <div>
                <button
                  ...
                  className="inline-flex justify-center w-full px-3 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
                >
            ...
            <Link href="/signin">
              <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded-full shadow-sm text-sm md:text-base">Sign In</button>
            </Link>
          )}
          ...
          {session ? (
            ...
            <Link href="/register">
              <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-3 rounded-full shadow-sm text-sm md:text-base">Sign up</button>
            </Link>
          )}
